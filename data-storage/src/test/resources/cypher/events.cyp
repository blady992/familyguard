MERGE (EventWithLocation:Event {name: 'Event with location', description: 'Description of event with location', locationName: 'FTIMS', locationLatitude: 51.747237, locationLongitude: 19.4534342}),
